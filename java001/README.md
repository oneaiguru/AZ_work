...
Скрипт повторно не скачивает артефакт, если он уже восстановлен. При необходимости можно удалить `gradle/wrapper/gradle-wrapper.jar` и запустить скрипт заново.
